...
/***/ "./src/javascripts/controllers/app-navTop-controller.js":
/*!**************************************************************!*\
  !*** ./src/javascripts/controllers/app-navTop-controller.js ***!
  \**************************************************************/
/*! no static exports found */
...
eval("const navTopView = __webpack_require__(/*! ../views/app-navTop.html */ \"./src/javascripts/views/app-navTop.html\");\r\n\r\nlet bool=true;\r\nconst render = () => {\r\n    $('.navBox').html(navTopView);\r\n    animateY();\r\n}\r\n\r\n\r\nfunction animateY(){\r\n    $('.menu').on('click',(e) => {\r\n        if(bool){\r\n            $('.navTop').css('opacity','1');\r\n            $('.mask').css({\r\n                'transform':'translateY(0)',\r\n            });\r\n            $('.main').css('z-index','10')\r\n        }\r\n        if(!bool){\r\n            $('.mask').css({\r\n                'transform':'translateY(-9.333333rem)',\r\n            });\r\n            $('.navTop').css('opacity','0');\r\n            $('.main').css('z-index','22')\r\n        }\r\n      bool=!bool;\r\n    })\r\n}\r\n\r\nmodule.exports={\r\n    render\r\n}\n\n//# sourceURL=webpack:///./src/javascripts/controllers/app-navTop-controller.js?");
...
eval("module.exports = \"<header class=\\\"headerTitle\\\">    <h1 class=\\\"logo\\\"></h1>    <a href=\\\"#\\\" class=\\\"search\\\"></a>    <a class=\\\"menu\\\" href=\\\"#\\\"></a></header>\"\n\n//# sourceURL=webpack:///./src/javascripts/views/app-header.html?");
...
/***/ "./src/javascripts/views/app-navTop.html":
/*!***********************************************!*\
  !*** ./src/javascripts/views/app-navTop.html ***!
  \***********************************************/
/*! no static exports found */
